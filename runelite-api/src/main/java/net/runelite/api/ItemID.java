...
/* This file is automatically generated. Do not edit. */
	...
	// --- OpenOSRS 4.31 compat aliases (names retired upstream; values verified in current gameval) ---

	// --- OpenOSRS 4.31 legacy ID aliases (force-added) ---
	public static final int CANNONBALL = 2;

	// --- OpenOSRS WeaponMap aliases ---
	public static final int EVENT_RPG = 2003;
	public static final int TRAILBLAZER_AXE = 30362;
	public static final int TRAILBLAZER_HARPOON = 30363;
	public static final int TRAILBLAZER_PICKAXE = 30364;

	// --- OpenOSRS legacy aliases batch 2 ---
	public static final int BRONZE_JAVELIN_HEADS = 5642;
	public static final int IRON_JAVELIN_HEADS = 5643;
	public static final int STEEL_JAVELIN_HEADS = 5644;
	public static final int MITHRIL_JAVELIN_HEADS = 5645;
	public static final int ADAMANT_JAVELIN_HEADS = 5646;
	public static final int RUNE_JAVELIN_HEADS = 5647;
	public static final int AMETHYST_JAVELIN_HEADS = 21190;
	public static final int COOKED_CRAB_MEAT = 7527;
