...
The current client builds independently from this repository. Revision-maintenance tooling is separate; public runtime mappings and dependency pins are part of each reviewed client update.

Plugin contributions can start in the separate OOSRS-Plugins repository. Use compile-only client dependencies and release plugins through a repository catalog.
